...
package-windows-amd64:
	...
	env CGO_ENABLED=0 GOARCH=amd64 GOOS=windows go build -trimpath -o ./listagent_windows_x86_64/listagent.exe main.go
...
package-windows-arm64:
	...
	env CGO_ENABLED=0 GOARCH=arm64 GOOS=windows go build -trimpath -o ./listagent_windows_arm64/listagent.exe main.go
...
package-darwin-amd64:
	...
	env CGO_ENABLED=0 GOARCH=amd64 GOOS=darwin go build -trimpath -o ./listagent_darwin_amd64/listagent main.go
...
package-darwin-arm64:
	...
	env CGO_ENABLED=0 GOARCH=arm64 GOOS=darwin go build -trimpath -o ./listagent_darwin_arm64/listagent main.go
